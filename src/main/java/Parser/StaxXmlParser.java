...
public class StaxXmlParser implements XMLParser {
    ...
    StaxXmlParser(PaperBuilder paperBuilder) {
            ...
            try {
                ...
                switch (event.getEventType()) {
                    ...
                    case XMLStreamConstants.START_ELEMENT:
                        ...
                        paperBuilder.setTag(startElement.getName().getLocalPart(), event.asCharacters().getData());
                        break;

                    case XMLStreamConstants.END_ELEMENT:
                        EndElement endElement = event.asEndElement();
                        if (endElement.getName().getLocalPart().equalsIgnoreCase(paperBuilder.getRootName())) {
                            paperBuilder.saveElement(paperBuilder.getRootName());
                        }
                        break;
                }
